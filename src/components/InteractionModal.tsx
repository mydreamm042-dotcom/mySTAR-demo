      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '56px 24px 24px', overflow: 'hidden' }}>
        ...
        {mode === 'select' && (
          <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              { m: 'heart' as Mode, emoji: '💖', label: '호감 표현', desc: '10분마다 1명에게 익명으로', color: '#ff6b6b', bg: 'rgba(255,107,107,0.1)', border: 'rgba(255,107,107,0.25)' },
              { m: 'warning' as Mode, emoji: '🤫', label: '자제 시그널', desc: '10분마다 익명으로 전달', color: '#f59e0b', bg: 'rgba(245,158,11,0.1)', border: 'rgba(245,158,11,0.25)' },
        ...
        {(mode === 'heart' || mode === 'warning') && (
          <div className="animate-fade-in" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            <p style={{ fontSize: 13, color: 'var(--muted2)', marginBottom: 20 }}>
              {mode === 'heart' ? '하트는 10분마다 보낼 수 있어요' : '자제 시그널은 10분마다 익명으로 전달돼요'}
            </p>
